...
import com.suye.iblog.repository.EsBlogRepository;
import com.suye.iblog.service.EsBlogService;
...
public class EsBlogServiceImpl implements EsBlogService {
	...
	@Override
	public List<TagItem> listTop30Tags() {
        ...
        while (modelBucketIt.hasNext()) {
            ...
            list.add(new TagItem(actiontypeBucket.getKey().toString(),
